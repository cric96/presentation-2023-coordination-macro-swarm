...
\only<2>{
	\centering
	\includegraphics[height=2.5cm]{img/aggregation.jpg}
	\includegraphics[height=2.5cm]{img/pattern-formation.png}
	\includegraphics[height=2.5cm]{img/sefl-assembly.jpg}
}
\only<4>{
	\centering
	\includegraphics[width=0.2\textwidth]{img/exploration.jpg}
	\includegraphics[width=0.2\textwidth]{img/navigation.jpg}
	\includegraphics[width=0.2\textwidth]{img/transportation.jpeg}
	\includegraphics[width=0.2\textwidth]{img/localization.png}
}
\end{frame}
...
\begin{exampleblock}{High-level description}
	\begin{itemize}
		\item A swarm of robots are deployed in a rectangular area
		\item A group of robots is assigned to explore the area
		\item Other robots are assigned to heal the injured robots
...
\begin{alertblock}{Pseudocode}
	\begin{enumerate}
		\item Form teams of robots with healers and explorers (team formation)
		\item Explore the area (Exploration)
		\item When a robot finds an injured, it broadcasts a message (leader-based)
